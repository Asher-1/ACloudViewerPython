...
if __name__ == "__main__":
    ...
    for i in range(1, num_scales):
        multiplier = pow(2, i)
        new_voxel_size = multiplier * min_cube_size
        pcd_curr_down, cubic_id, original_indices = pcd_curr.voxel_down_sample_and_trace(
            new_voxel_size, min_bound, max_bound, False)
        print("\nScale %f, # of points %d" %
