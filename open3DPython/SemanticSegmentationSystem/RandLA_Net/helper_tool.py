...
class ConfigSemantic3D:
    ...
    nn_method = "open3d"  # "sklearn", "open3d", "cppWrapper"
    sampling_method = "open3d"  # "open3d", "cppWrapper"
...
class DataProcessing:
    ...
    def open3d_knn_search(support_pts, query_pts, k):
        ...
        :return: neighbor_idx: neighboring points indexes, B*N2*k
        """
        return tools.KNNNeighbors.single_knn_search(support_pts, query_pts, k)

    @staticmethod
    def open3d_voxel_sampling(points, features=None, grid_size=0.1):
        return tools.Utility.voxel_sampling(points, features, grid_size)
