...
download_redwood_scene()
{
    ...
    wget https://github.com/Asher-1/cloudViewer_downloads/releases/download/redwood-simulated/$DATA_NAME-color.zip

    # Source: http://redwood-data.org/indoor/data/$DATA_NAME-depth-clean.zip
    wget https://github.com/Asher-1/cloudViewer_downloads/releases/download/redwood-simulated/$DATA_NAME-depth-clean.zip

    # Source: http://redwood-data.org/indoor/data/$DATA_NAME-depth-simulated.zip
    wget https://github.com/Asher-1/cloudViewer_downloads/releases/download/redwood-simulated/$DATA_NAME-depth-simulated.zip
