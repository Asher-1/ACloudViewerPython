 ...
 "cells": [
  ...
  },
  {
   ...
   "source": [
    ...
    "pcd.colors = cv3d.utility.Vector3dVector(np.random.uniform(0, 1, size=(N, 3)))\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "\n",
    "    # carve voxel grid\n",
    "    pcd_agg = cv3d.geometry.PointCloud()\n",
    ...
    "        pcd_agg += cv3d.geometry.PointCloud.create_from_depth_image(\n",
