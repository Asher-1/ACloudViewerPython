...
class BaseDetector(metaclass=ABCMeta):
    ...
    @staticmethod
    def wrapper_dict(result, time_take, state):
        return {'result': result, 'infer_time_take': time_take, 'state': state}
    ...
    def run(self, data):
        ...
        if data is None or len(data) < 1:
            ...
            return BaseDetector.wrapper_dict([], 0, message)
        ...
        return BaseDetector.wrapper_dict(detect_result, round(time_take, 4), 'success')
